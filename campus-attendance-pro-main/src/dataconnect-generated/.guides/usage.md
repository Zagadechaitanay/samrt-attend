...
```ts
import { useCreateNewUser, useGetUserByUsername, useEnrollStudentInCourse, useListAvailableCourses } from '@dataconnect/generated/react';
...
```js
import { createNewUser, getUserByUsername, enrollStudentInCourse, listAvailableCourses } from '@dataconnect/generated';
